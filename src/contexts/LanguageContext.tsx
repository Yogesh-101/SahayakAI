...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    check_uan_invalid: 'Enter a valid 9-digit demo UAN (e.g. 123456789).',
    ...
    home_quick_start_subtitle: 'Use demo UANs below — 9 digits each. No login required.',
  ...
  hi: {
    ...
    check_uan_invalid: 'मान्य 9-अंकीय डेमो UAN दर्ज करें (जैसे 123456789)।',
    ...
    home_quick_start_subtitle: 'नीचे डेमो UAN का उपयोग करें — प्रत्येक 9 अंक। लॉगिन की आवश्यकता नहीं।',
