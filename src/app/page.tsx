      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#f0eaf8] via-[#ebe3f5] to-white py-14 sm:py-16 lg:py-20">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="mt-8 max-w-3xl mx-auto grid sm:grid-cols-3 gap-3 animate-fade-up" style={{ animationDelay: '0.45s' }}>
              {ENTRY_POINTS.map((entry) => (
                <Link key={entry.title} href={entry.href} className="h-full">
                  <div className={`gov-card h-full rounded-xl border ${entry.border} bg-white/90 p-4 hover:shadow-md transition-all min-h-[120px] flex flex-col text-left`}>
